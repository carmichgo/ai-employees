/**
 * Background utilities — adapted from OpenClaw's background-utils.js
 * for the Blitzer AI Browser Relay extension.
 */
...
export function isRetryableReconnectError(err) {
  ...
  if (message.includes("Missing gatewayToken")) return false;
  return true;
}
