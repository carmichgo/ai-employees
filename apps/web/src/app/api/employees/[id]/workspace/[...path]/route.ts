/**
 * Workspace file proxy — serves and deletes files from an employee's workspace.
 * Used for displaying screenshots, generated images, and other files in the chat.
 *
 * GET    /api/employees/[id]/workspace/[...path]  — serve a file
 * DELETE /api/employees/[id]/workspace/[...path]  — delete a file
 */
