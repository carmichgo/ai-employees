...
echo "  3. Link env file:  ln -sf /opt/ai-employees/.env /opt/ai-employees/app/.env"
echo "  4. Start:  cd /opt/ai-employees/app && docker compose up -d"
echo "  5. Set BACKEND_URL and BACKEND_SECRET in Vercel env vars"
echo "  6. Point your API_DOMAIN DNS to this droplet's IP"
echo ""
echo "To update later (without destroying employee containers):"
echo "  cd /opt/ai-employees/app && bash infrastructure/deploy.sh"
echo ""
